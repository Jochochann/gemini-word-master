    ...
    <div className="flex flex-col h-full w-full max-w-5xl mx-auto p-2 sm:p-4 md:p-8 animate-in fade-in duration-500">
      <div className="mb-4 sm:mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-xs sm:text-sm">Browsing {words.length} items</p>
        </div>
          ...
          <table className="w-full text-left border-collapse min-w-[320px]">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200">
                ...
                <th className="px-4 py-3 text-[10px] font-bold text-slate-400 uppercase tracking-widest w-20 text-center"></th>
              </tr>
            </thead>
                  ...
                  <tr key={w.id} className="hover:bg-blue-50/40 transition-colors group">
                    ...
                    <td className="px-4 py-4">
                      <button 
                        ...
                        className="font-bold text-sm sm:text-base text-slate-800 hover:text-blue-600 transition-colors"
                      >
                        {w.word}
                      </button>
                    </td>
