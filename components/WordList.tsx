...
const WordList: React.FC<WordListProps> = ({ words, onSelectWord, lang = 'en-US' }) => {
  ...
  return (
    <div className="flex flex-col h-full w-full max-w-5xl mx-auto p-2 sm:p-4 md:p-8 animate-in fade-in duration-500">
      <div className="mb-6 sm:mb-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <table className="w-full text-left border-collapse min-w-[320px]">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200 sticky top-0 z-10">
                <th className="px-5 py-4 text-[12px] font-bold text-slate-400 uppercase tracking-widest text-center w-12 sm:w-20">No.</th>
                <th className="px-5 py-4 text-[12px] font-bold text-slate-400 uppercase tracking-widest">Word</th>
                <th className="px-5 py-4 text-[12px] font-bold text-slate-400 uppercase tracking-widest">Meaning</th>
                <th className="px-5 py-4 text-[12px] font-bold text-slate-400 uppercase tracking-widest hidden sm:table-cell">Example</th>
                <th className="px-5 py-4 text-[12px] font-bold text-slate-400 uppercase tracking-widest w-28 text-center">Action</th>
              </tr>
            </thead>
